...
def test_encode_cwd_url_style():
    assert encode_cwd("/Users/vbusnita/token-tracker") == "%2FUsers%2Fvbusnita%2Ftoken-tracker"


def test_path_basename():
    assert path_basename("/Users/vbusnita/token-tracker/plugins/focus-audio/daemon.py") == "daemon.py"
...
def test_clean_collapses_absolute_paths():
    src = (
        "Edited /Users/vbusnita/token-tracker/plugins/focus-audio/focus_audio/brief.py "
...
def test_find_session_dir(tmp_path: Path):
    cwd = "/Users/vbusnita/token-tracker"
